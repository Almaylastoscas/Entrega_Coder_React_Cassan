    ...
    <>
      {!carrito.length ? (
        <div className="bg-red-500">
          <Link to={"/"}>
            <h1 className="text-black text-4xl ">
              No hay productos añadidos Selecionelos aqui
            </h1>
          </Link>
        </div>
      ) : (
        <div className="content-center justify-center h-screen ">
            ...
            <div className="justify-center" key={el.id}>
              <div className="mx-10 pt-15 justify-center ">
                <div className="grid gap-6 mb-8 md:grid-cols-1 justify-centers ">
                  <div className="min-w-0 p-4 text-white bg-rose-500 rounded-lg shadow-xs  ">
          ...
          <h1 className="text-white"> total $ {totalCompra()}</h1>
          <Link to={"/formulario"}>
